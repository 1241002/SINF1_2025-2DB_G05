                    ...
                    <div class="card event-card shadow-lg">
                        ...
                        <div class="card-body p-4">
                            <form method="POST" class="needs-validation" novalidate>
                                ...
                                <div class="mb-3"><input type="text" name="localizacao" class="form-control" required placeholder="Localização no recinto"></div>
                                <div class="row mb-3">
                            ...
                            <table class="table table-sm align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="small"><?php echo htmlspecialchars($fac['colour'] ?? '-'); ?></td>
                                        <td class="text-end">
                                            <button type="button" class="btn btn-outline-light btn-sm me-1" data-bs-toggle="modal" data-bs-target="#editFac<?php echo $fac['id']; ?>">Editar</button>
                                            <a href="admin.php?delete_faculty=<?php echo $fac['id']; ?>" class="btn btn-outline-danger btn-sm" onclick="return confirm('Remover <?php echo htmlspecialchars($fac['name']); ?>?
